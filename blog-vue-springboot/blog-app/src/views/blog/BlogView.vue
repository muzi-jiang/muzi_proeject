<template>
  <div class="me-view-body" v-title :data-title="title" style="width:100%;">
    <el-container class="me-view-container" style="width:90%;margin:0px auto">
      ...
      <el-main >
        ...
        <div class="me-view-card" >
          ...
          <div class="me-view-content">
            <markdown-editor :editor=article.editor style="box-shadow:none;font-size:20px"></markdown-editor>
          </div>
